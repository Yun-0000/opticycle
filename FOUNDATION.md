...
This is the only first-party file that names the upstream foundation in full. README points here. Public evidence artifacts do not repeat the upstream project name.
...
- Alpaca signed MLEG limit semantics (positive debit, negative credit)

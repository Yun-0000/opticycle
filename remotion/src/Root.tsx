    ...
    <>
      <Folder name="Opticycle-Scenes">
        <Composition
          ...
          durationInFrames={SCENE_FRAMES.oneLiner}
          fps={FPS}
          width={WIDTH}
          height={HEIGHT}
        />
        <Composition
          id="ScenePaperBook"
          component={ScenePaperBook}
          durationInFrames={SCENE_FRAMES.paperBook}
          fps={FPS}
          width={WIDTH}
          height={HEIGHT}
        />
        <Composition
          id="SceneCycle"
          component={SceneCycle}
          durationInFrames={SCENE_FRAMES.cycle}
          fps={FPS}
          width={WIDTH}
          height={HEIGHT}
        />
        <Composition
          id="SceneRisk"
          component={SceneRisk}
          durationInFrames={SCENE_FRAMES.risk}
          fps={FPS}
          width={WIDTH}
          height={HEIGHT}
        />
        <Composition
          id="SceneExecution"
          component={SceneExecution}
          durationInFrames={SCENE_FRAMES.execution}
          fps={FPS}
          width={WIDTH}
          height={HEIGHT}
        />
        <Composition
          id="SceneRunOnce"
          component={SceneRunOnce}
          durationInFrames={SCENE_FRAMES.runOnce}
          fps={FPS}
          width={WIDTH}
          height={HEIGHT}
        />

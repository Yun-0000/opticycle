...
export const SceneCycle: React.FC<{durationInFrames?: number}> = ({durationInFrames = 210}) => {
  ...
  return (
    <SceneFrame durationInFrames={durationInFrames} index="02 / 06">
      ...
      <div style={{position: "absolute", left: 74, bottom: 150, display: "flex", gap: 54, opacity: show(frame, 58, 14)}}>
        <Label style={{fontSize: 22}}>■ BULLISH</Label>
        <Label style={{fontSize: 22}}>■ BEARISH</Label>
        <Label color={c.yellow} style={{fontSize: 22}}>■ NO_TRADE</Label>
      </div>

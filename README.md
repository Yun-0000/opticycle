...
<p align="center">
  <a href="artifacts/demo.mp4"><strong>Watch the demo</strong></a>
  ...
  · <a href="artifacts/opticycle-slides.pdf">Open the slide deck</a>
</p>
...
| Open-position unrealized P&L | **+$77.00** | Sep 3, 19:43 PDT Alpaca CLI snapshot |
| Account equity | **$100,132.45** | same snapshot; current committed account truth |
| Historical equity observation | **$100,086.45** | latest daily portfolio-history endpoint; not current equity |

The exact broker identity is `$100,281.45 cash + $283.00 long market value − $432.00 short market value = $100,132.45 equity`. The separate performance bridge is `$100,000 + $55.67 + $77.00 = $100,132.67`; the $0.22 broker-level residual is disclosed rather than force-fit.
...
- **Slide deck (submission PDF):** [`artifacts/opticycle-slides.pdf`](artifacts/opticycle-slides.pdf)
- **Editable deck:** [`artifacts/opticycle-slides.pptx`](artifacts/opticycle-slides.pptx)
